...
CREATE INDEX IF NOT EXISTS "RestaurantConsumptionRecord_tenantId_branchId_warehouseId_status_consumptionDate_idx"
  ON "RestaurantConsumptionRecord"("tenantId", "branchId", "warehouseId", "status", "consumptionDate");

CREATE INDEX IF NOT EXISTS "RestaurantInventoryMovement_tenantId_branchId_warehouseId_occurredAt_referenceType_movementType_idx"
  ON "RestaurantInventoryMovement"("tenantId", "branchId", "warehouseId", "occurredAt", "referenceType", "movementType");

CREATE INDEX IF NOT EXISTS "RestaurantStockCount_tenantId_branchId_warehouseId_status_countedAt_idx"
  ON "RestaurantStockCount"("tenantId", "branchId", "warehouseId", "status", "countedAt");

CREATE INDEX IF NOT EXISTS "RestaurantInventoryBalance_tenantId_branchId_warehouseId_updatedAt_idx"
