...
export class AuditService {
  ...
  async logHttpRequest(request: RequestWithUser, statusCode: number) {
    ...
    await this.safeCreate({
      ...
      email,
      domain,
      entityId: request.auditEntityId ?? null,
      entityType: request.auditEntityType ?? null,
      before: request.auditBefore ?? null,
      after: request.auditAfter ?? null,
