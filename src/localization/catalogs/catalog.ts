...
export type MessageCode =
  ...
  | 'offer_pdf.candidate'
  | 'offer_pdf.position'
  | 'offer_pdf.compensation'
  | 'offer_pdf.start_date'
  | 'offer_pdf.valid_until'
  | 'offer_pdf.benefits'
  | 'offer_pdf.none_specified'
  | 'offer_pdf.language_es'
  | 'offer_pdf.language_en'
  | 'offer_pdf.translation_notice'
